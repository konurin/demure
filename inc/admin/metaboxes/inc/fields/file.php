...
class RWMB_File_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		self::localize_script( 'rwmb-file', 'rwmbFile', array(
			'maxFileUploadsSingle' => esc_html__( 'You may only upload maximum %d file', 'demure' ),
			'maxFileUploadsPlural' => esc_html__( 'You may only upload maximum %d files', 'demure' ),
		) );
	}
	...
	public static function wp_ajax_delete_file() {
		...
		wp_send_json_error( esc_html__( 'Error: Cannot delete file', 'demure' ) );
	}
	...
	public static function html( $meta, $field ) {
		$i18n_title = apply_filters( 'rwmb_file_upload_string', _x( 'Upload Files', 'file upload', 'demure' ), $field );
		$i18n_more  = apply_filters( 'rwmb_file_add_string', _x( '+ Add new file', 'file upload', 'demure' ), $field );
	...
	protected static function file_html( $file ) {
		$i18n_delete = apply_filters( 'rwmb_file_delete_string', _x( 'Delete', 'file upload', 'demure' ) );
		$i18n_edit   = apply_filters( 'rwmb_file_edit_string', _x( 'Edit', 'file upload', 'demure' ) );
