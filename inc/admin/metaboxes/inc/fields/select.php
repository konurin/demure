...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="rwmb-select-all-none">' . esc_html__( 'Select', 'demure' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'demure' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'demure' ) . '</a></div>';
		}
		return '';
	}
}
